    ...
    <div className="reviews-tab">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-medium text-green-800">DomiHive Verified Reviews</h4>
            <p className="text-sm text-green-600">All reviews are from verified tenants who have lived in this property</p>
          </div>
        </div>
      </div>
